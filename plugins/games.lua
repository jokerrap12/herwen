...
if MsgText[1] == 'قي انهي ايد' or MsgText[1] == 'بات' then   
Num = math.random(1,6)
...
• اختر لأستخراج الفي انهي ايد أليد التي تحمل الفي انهي ايد 
...
• في انهي ايد ↤︎ لعبه في انهي ايد الشهيره
...
if msg.text:match("^(%d+)$") then
if tonumber(msg.text:match("^(%d+)$")) > 99999999999999999999999999999999999999999999999999 then
sendMsg(msg.chat_id_,msg.id_,"*• لا تستطيع اضافه اكثر من 99999999999999999999999999999999999999999999999999\n*")   
