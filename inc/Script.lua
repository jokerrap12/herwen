...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/jokerrap12/HERWENFILE/master/GetVersion.txt' ) or 0
...
elseif Text== "العالمي" or Text== "عالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس عند هروين♡](https://t.me/@Alamy3)")
elseif Text== "جوكر" or Text== "جوكر راب" then return  sendMsg(msg.chat_id_,msg.id_,"[الجامد بتاع التلي ✮](https://t.me/jokerrap1)")
