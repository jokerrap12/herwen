...
redis:set(herwen.."getidus"..msg.chat_id_, "Photo")
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/clayy1"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : كلاي ](https://t.me/clayy1)' ,nil,inline,msg.id_)
return false
end
...
if text:match("^source$") or text:match("^اصدار$") or text:match("^الاصدار$") or  text:match("^السورس$") or text:match("^سورس$") and herwen(msg) then 
local inline = {
...
send_inline(msg.chat_id_,'☼↣مرحبا بك في سورس كوين┋Queen ،\n☼↣اضغط على الازرار بالاسفل ⬇️ ،',nil,inline) 
return false 
end
...
ٴ≪━━━━━clay━━━━━≫ٴ
 ...
 ✸ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "جوكر" or Text== " هروين " or Text=="عالمي" then
