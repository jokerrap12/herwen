...
local inline = {{{text="❀ قناة‏‏ السورس أضغط هنا ",url="t.me/‏clayy1"}}}
send_key(msg.sender_user_id_,'  [❀ قناة سورس : العالمي](t.me/‏clayy1)',nil,inline,msg.id_)
return false
end
...
return if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
return [[
✧𝕋𝔼𝔸𝕄 ℂ𝕃𝔸𝕐“✧
 ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
✧ ⇉ [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓](t.me/Alamy3)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
✧ ⇉ [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓](t.me/mhzon1)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
✧ ⇉ [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓](t.me/jokerrap1)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
✧ ⇉ [𝑪𝑯𝑨𝑵𝑵𝑬𝑳“](t.me/clayy1)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
✧ ⇉ [𝑻𝑶 𝑻𝑨𝑳𝑲 𝑼𝑺](t.me/FlassTas4_bot)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
]]
end
end
...
elseif Text== "العالمي" or Text== "حبيب الكل" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس ❀](https://t.me/herwen3)")
elseif Text== "سام" or Text== "ساموراي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/XxxMalificentxxX)")
elseif Text== "جوكر" or Text== "جوكر راب" then return  sendMsg(msg.chat_id_,msg.id_,"[اجمد واحد ف التلي](https://t.me/jokerrap1)")
elseif Text== "هروين" or Text== "بتاع الترعه" then return  sendMsg(msg.chat_id_,msg.id_,"[مالك السورس](https://t.me/mhzon1)")
...
elseif Text== "اوامر التسليه"  then return sendMsg(msg.chat_id_,msg.id_,"\n‌‌‏ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 مرحباً عزيزي\nٴ𐄬 هذي اوامر التسليه:  \nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬\nٴ𐄬 رفع › تنزيل ❬ متوحد ❭\nٴ𐄬 رفع › تنزيل ❬ وتكه ❭\nٴ𐄬 رفع › تنزيل ❬ غبي ❭\nٴ𐄬 رفع › تنزيل ❬ كلب ❭\nٴ𐄬 رفع › تنزيل ❬ حمار ❭\nٴ𐄬 رفع › تنزيل ❬ زوجتي ❭\nٴ𐄬 رفع › تنزيل ❬ متوحده ❭\nٴ𐄬 رفع › ❬ بقلبي ❭ تنزيل › ❬ من قلبي❭\nٴ𐄬 ❬ طلاق ❭ › ❬ زواج ❭\nٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬ٴ𐄬")
  ...
  return sendMsg(msg.chat_id_,msg.id_,[[
  ❀ هترجع تاني و هستناك
❀ [رابط حذف حساب التليجرام](https://telegram.org/deactivate) - .
‏
  ]] )
  --=====================================
  elseif Text== "العالمي" or Text== "جوكر" or Text=="هروين" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس ♕](https://t.me/clayy1) ")
