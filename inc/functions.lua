...
─────▀██▀─────
│hayah ‿ @Alamy3 
تم تطوير وبرمجة السورس من قبل  مطورين سورس العالمي
│@Alamy3 ‿ @jokerrap1
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(Hayah..":NameBot:")
...
var =  'مطور السورس'
elseif redis:sismember(Hayah..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(Hayah..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(Hayah..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(Hayah..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(Hayah..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(Hayah..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(Hayah..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(Hayah..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(Hayah..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(Hayah..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(Hayah..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(Hayah..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(Hayah..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(Hayah..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(Hayah..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(Hayah..':SUDO_BOT:')
message = '♲ ** قائمه الـمـطـوريـن : \n\n`♲ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(Hayah..'username:'..v)
local count = redis:scard(Hayah..'mtwr_count'..v)
...
local monsha = redis:smembers(Hayah..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n♲ قائمه المدراء :*\n\n'
local list = redis:smembers(Hayah..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(Hayah..'admins:'..msg.chat_id_)
...
local list = redis:smembers(Hayah..'whitelist:'..msg.chat_id_)
...
if redis:sismember(Hayah..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(Hayah..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(Hayah..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(Hayah..'banned:'..msg.chat_id_)
...
if redis:sismember(Hayah..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(Hayah..'gban_users')
...
local list = redis:smembers(Hayah..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(Hayah..':Filter_Word:'..msg.chat_id_,word) then 
return  "♲ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(Hayah..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(Hayah..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(Hayah..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(Hayah..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(Hayah..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(Hayah..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(Hayah..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..Hayah..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(Hayah..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(Hayah..'group:name'..GroupS) or '')
...
local admins = redis:smembers(Hayah..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(Hayah..'username:'..value)
if info then 
...
local creators = redis:smembers(Hayah..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(Hayah..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(Hayah..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(Hayah..'group:ids')
message = '♲ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(Hayah..'group:name'..v)
if info then 
...
redis:del(
Hayah..'group:add'..id_group,
Hayah..'lock_link'..id_group, 
Hayah..'lock_id'..id_group,
Hayah..'lock_spam'..id_group, 
Hayah..'lock_webpage'..id_group,
Hayah..'lock_markdown'..id_group,
Hayah..'lock_flood'..id_group,
Hayah..'lock_bots'..id_group,
Hayah..'mute_forward'..id_group,
Hayah..'mute_contact'..id_group,
Hayah..'mute_location'..id_group,
Hayah..'mute_document'..id_group,
Hayah..'mute_keyboard'..id_group,
Hayah..'mute_game'..id_group,
Hayah..'mute_inline'..id_group,
Hayah..'lock_username'..id_group,
Hayah..'num_msg_Hayah'..id_group,
Hayah..'replay'..id_group
)
redis:srem(Hayah..'group:ids',id_group)
end
...
redis:hset(Hayah..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(Hayah..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(Hayah..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(Hayah..'group:add'..msg.chat_id_) then  return '♲ **المجموعة تم تفعيلها مُسبقاً . ' end

local UserChaneel = redis:get(Hayah..":UserNameChaneel")
...
redis:setex(Hayah..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(Hayah..':addnumberusers') or 0)
...
local lock_service = redis:get(Hayah..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(Hayah..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(Hayah..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
Hayah..'group:add'..msg.chat_id_,true,
Hayah..'lock_link'..msg.chat_id_,true, 
Hayah..'lock_id'..msg.chat_id_,true,
Hayah..'lock_spam'..msg.chat_id_,true,
Hayah..'lock_webpage'..msg.chat_id_,true,
Hayah..'lock_markdown'..msg.chat_id_,true,
Hayah..'lock_flood'..msg.chat_id_,true,
Hayah..'lock_bots'..msg.chat_id_,true,
Hayah..'mute_forward'..msg.chat_id_,true,
Hayah..'mute_contact'..msg.chat_id_,true,
Hayah..'mute_location'..msg.chat_id_,true,
Hayah..'mute_document'..msg.chat_id_,true,
Hayah..'mute_keyboard'..msg.chat_id_,true,
Hayah..'mute_game'..msg.chat_id_,true,
Hayah..'mute_inline'..msg.chat_id_,true,
Hayah..'lock_username'..msg.chat_id_,true,
Hayah..'num_msg_Hayah'..msg.chat_id_,5, 
Hayah..'replay'..msg.chat_id_,true
)

redis:sadd(Hayah..'group:ids',msg.chat_id_) 
redis:sadd(Hayah..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(Hayah..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(Hayah..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(Hayah..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(Hayah..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID,'username',Resolv)
redis:sadd(Hayah..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(Hayah..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(Hayah..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(Hayah..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID,'username',Resolv)
redis:sadd(Hayah..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(Hayah..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(Hayah..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(Hayah..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(Hayah..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(Hayah..'whitelist:'..ChatID,UserID)
...
if redis:sismember(Hayah..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..'owners:'..ChatID,UserID)
...
if redis:sismember(Hayah..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(Hayah..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(Hayah..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(Hayah..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(Hayah..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(Hayah..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(Hayah..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(Hayah..'banned:'..ChatID,UserID)
...
if redis:sismember(Hayah..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(Hayah..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(Hayah..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(Hayah..'username:'..UserID, 'username',Resolv)
redis:sadd(Hayah..'gban_users',UserID)
...
redis:srem(Hayah..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(Hayah..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(Hayah..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(Hayah..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(Hayah..'username:'..UserID, 'username', UserName)
redis:sadd(Hayah..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(Hayah..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'♲ **العضو » ❪ '..UserName..' ❫\n♲ **الايدي » ❪ `'..UserID..'` ❫\n♲ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"♲ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(Hayah..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"♲ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(Hayah..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"♲ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(Hayah..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(Hayah..'username:'..UserID, 'username', Resolv)
redis:sadd(Hayah..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(Hayah..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(Hayah..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'♲ **العضو » '..USERNAME..' \n♲ ** الايدي » (`'..UserID..'`)\n♲ **انه بالتأكيد ليس مطور \n') end
redis:srem(Hayah..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'♲ العضو » ❪ '..USERNAME..' ❫\n♲ الايدي » ❪ '..UserID..' ❫\n♲ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(Hayah..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(Hayah..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(Hayah..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(Hayah..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*♲*` اعدادات المجموعه :` \n"
.."\n♲ التعديل «» "..(redis:get(Hayah..'lock_edit'..msg.chat_id_) or 'false')
.."\n♲ الروابط «» "..(redis:get(Hayah..'lock_link'..msg.chat_id_) or 'false')
.."\n♲ التاك «» "..(redis:get(Hayah..'lock_tag'..msg.chat_id_) or 'false')
.."\n♲ المعرفات «» "..(redis:get(Hayah..'lock_username'..msg.chat_id_) or 'false')
.."\n♲ التكرار «» "..(redis:get(Hayah..'lock_flood'..msg.chat_id_) or 'false')
.."\n♲ الكلايش «» "..(redis:get(Hayah..'lock_spam'..msg.chat_id_) or 'false')
.."\n♲ الويب «» "..(redis:get(Hayah..'lock_webpage'..msg.chat_id_) or 'false')
.."\n♲ الماركدوان «» "..(redis:get(Hayah..'lock_markdown'..msg.chat_id_) or 'false')
.."\n♲ بالطرد البوتات «» "..(redis:get(Hayah..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n♲ البوتات «» "..(redis:get(Hayah..'lock_bots'..msg.chat_id_) or 'false')
.."\n♲ عدد التكرار «» "..(redis:get(Hayah..'num_msg_Hayah'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n♲`اعدادات الوسائط :`\n"
.."\n*♲ *المتحركه «» "..(redis:get(Hayah..'mute_gif'..msg.chat_id_) or 'false')
.."\n♲ الدردشه «» "..(redis:get(Hayah..'mute_text'..msg.chat_id_) or 'false')
.."\n♲ الانلاين «» "..(redis:get(Hayah..'mute_inline'..msg.chat_id_) or 'false')
.."\n♲ الالعاب «» "..(redis:get(Hayah..'mute_game'..msg.chat_id_) or 'false')
.."\n♲ الصور «» "..(redis:get(Hayah..'mute_photo'..msg.chat_id_) or 'false')
.."\n♲ الفيديو «» "..(redis:get(Hayah..'mute_video'..msg.chat_id_) or 'false')
.."\n♲ البصمات «» "..(redis:get(Hayah..'mute_audio'..msg.chat_id_) or 'false')
.."\n♲ الصوت «» "..(redis:get(Hayah..'mute_voice'..msg.chat_id_) or 'false')
.."\n♲ الملصقات «» "..(redis:get(Hayah..'mute_sticker'..msg.chat_id_) or 'false')
.."\n♲ الجهات «» "..(redis:get(Hayah..'mute_contact'..msg.chat_id_) or 'false')
.."\n♲ التوجيه «» "..(redis:get(Hayah..'mute_forward'..msg.chat_id_) or 'false')
.."\n♲ الموقع «» "..(redis:get(Hayah..'mute_location'..msg.chat_id_) or 'false')
.."\n♲ الملفات «» "..(redis:get(Hayah..'mute_document'..msg.chat_id_) or 'false')
.."\n♲ الاشعارات «» "..(redis:get(Hayah..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n♲ الكيبورد «» "..(redis:get(Hayah..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♲*`اعدادات اخرى : `"
.."\n\n*♲*الترحيب «» "..welcomex
.."\n*♲*الردود «» "..replayx
...
.."\n*♲*الويب «» "..(redis:get(Hayah..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*♲*الماركدوان «» "..(redis:get(Hayah..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*♲*البوتات بالطرد «» "..(redis:get(Hayah..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*♲*البوتات «» "..(redis:get(Hayah..'lock_bots'..msg.chat_id_) or 'false')
.."\n*♲*عدد التكرار «» "..(redis:get(Hayah..'num_msg_Hayah'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*♲*اعدادات التقـييد :\n"
.."\n*♲*التقييد بالتوجيه «» "..(redis:get(Hayah..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*♲*التقييد بالصور «» "..(redis:get(Hayah..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*♲*التقييد بالروابط «» "..(redis:get(Hayah..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*♲*التقييد بالمتحركه «» "..(redis:get(Hayah..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*♲*التقييد الفيديو «» "..(redis:get(Hayah..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
